                       ...
                       unsigned int keybits)
{
    ...
    if ((ret = lalu_gcm_setkey(ctx, cipher, key, keybits)) != 0) {
        return ret;
    }
#else
                       ...
                       const unsigned char *iv, size_t iv_len)
{
    ...
    ret = lalu_gcm_starts(ctx, mode, iv, iv_len);
                          ...
                          const unsigned char *add, size_t add_len)
{
    ...
    ret = lalu_gcm_update_ad(ctx, add, add_len);
